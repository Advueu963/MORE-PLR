...
"""
    Script to produce Political Data results for partial label ranking with missing labels
"""
...
if __name__ == "__main__":
    ...
    #### Single Target #####
    regr_estimator = RandomForestRegressor(random_state=random_state, n_jobs=n_jobs)
    ...
    model_names = [
        ...
        regr_name_singleTarget_RR,
        regr_name_singleTarget_PI,
        regr_name_mort,
        regr_name_mort_interval,
    ...
    for file in data_files:
        ...
        mort_PI_Pipeline = Pipeline(
            steps=[("preprocessor", preprocessor),
                   (regr_name_mort_interval, regr_model_mort_interval)]
        )
        ...
        singleTargetRF_Pipeline = Pipeline(
            steps=[
                ("preprocessor", preprocessor),
                (regr_name_singleTarget_RR, regr_model_singleTarget_RF),
            ]
        )
        ...
        singleTargetRF_PI_Pipeline = Pipeline(
            steps=[
                ("preprocessor", preprocessor),
                (regr_name_singleTarget_PI, regr_model_singleTarget_RF_PI),
            ]
        )
        # JC-RF
    ...
    plotData.to_csv(DATA_DIR / DATA_FOLDER / "PLR_politicalEvaluation_Missing.csv")
