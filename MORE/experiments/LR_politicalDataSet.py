...
if __name__ == "__main__":
    ...
    regr_model_singleTarget_RF_RR = PLR_MultiOutputRegressor(
    ...
    for file in data_files:
        ...
        singleTargetRF_Pipeline = Pipeline(
            steps=[
                ("preprocessor", preprocessor),
                (regr_name_singleTarget_RR, regr_model_singleTarget_RF_RR),
            ]
        )
    ...
    plotData.to_csv(DATA_DIR / "LR_politicalEvaluation.csv")
