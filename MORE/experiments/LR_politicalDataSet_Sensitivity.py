...
if __name__ == "__main__":
    ...
    for file in data_files:
        ...
        ST_intervalRF_Pipeline = Pipeline(
            steps=[
                ...
                (regr_name_singleTarget_PI, regr_model_interval_ST),
            ]
        )
        ...
        #MORT-PI
        mort_interval_pipeline = Pipeline(
            steps=[
                ("preprocessor", preprocessor),
    ...
    plotData.to_csv(DATA_DIR / DATA_FOLDER / f"LR_politicalEvaluation_coverage={coverage}.csv")
