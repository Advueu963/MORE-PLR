...
if __name__ == "__main__":
    ...
    model_names = [
        (regr_model_mort,                           regr_name_mort),
        (regr_model_mort_interval,                  regr_name_mort_interval),
        (regr_model_rounding,                       regr_name_rounding_rf),
        (regr_model_interval,                       regr_name_interval_rf),
        (regr_model_singleTarget,                   regr_name_singleTarget_RR),
        (regr_model_singleTarget_interval,          regr_name_singleTarget_PI),
        (clas_model_randomForest,                   clas_name_randomForest)
    ]
    
    model,model_name = model_names[number]
