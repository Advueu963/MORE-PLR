...
if __name__ == "__main__":
    ...
    model = regr_model_interval_Chain
    model_name = regr_name_interval_gb
    ...
    df.to_csv(DATA_DIR / DATA_FOLDER / f"LR-{model_name}-Missing={percentage}-coverage={coverage}_{rank_encoding}.csv")
