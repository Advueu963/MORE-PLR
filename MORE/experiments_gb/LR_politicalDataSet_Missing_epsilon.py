...
if __name__ == "__main__":
    ...
    DATA_FOLDER = "LR-GBR/missingLabels/lr-political/epsi"
    ...
    for file in data_files:
        ...
        models_singletarget_names = [
            regr_name_gb_singleTarget_Epsi+f"({epsilon})" 
            for epsilon in epsilon_values
            for _ in ENCODINGS
        ]
        ...
        models_chain_names = [
            regr_name_chain_gb_Epsi+f"({epsilon})" 
            for epsilon in epsilon_values
            for _ in ENCODINGS
        ]
        ...
        models = [
                    *models_singletarget_epsilon,
                    *models_chain_epsilon,
                ] # 44 + 44 == 88 Combinations
        models_names = [
                *models_singletarget_names,
                *models_chain_names,
            ]
        model,encoding = models[number]
    ...
    plotData.to_csv(DATA_DIR / DATA_FOLDER / f"LR_politicalEvaluation_Missing_{model_name}_{encoding}.csv")
