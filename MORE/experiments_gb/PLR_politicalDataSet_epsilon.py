...
if __name__ == "__main__":
    ...
    for file in data_files:
        ...
        models_singletarget_names = [
            regr_name_gb_singleTarget_Epsi+f"({epsilon})" for epsilon in epsilon_values
        ]
        ...
        for epsilon in epsilon_values]
        models_chain_names = [
            regr_name_chain_gb_Epsi+f"({epsilon})" for epsilon in epsilon_values
        ]
    ...
    plotData.to_csv(DATA_DIR /"PLR-GBR" / f"PLR_politicalEvaluation_epsilon_{rank_encoding}.csv")
