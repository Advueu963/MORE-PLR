...
def add_to_data(data, data_name,score,time,bucket_per_rank,algo):
...
if __name__ == '__main__':
    ...
    models = [clas_model,regr_model_singleTarget, regr_model_chain]
    models_name = [clas_name, regr_name_singleTarget, regr_name_chain]
    ...
    pd.DataFrame(data).to_csv(
        f"../data/MultiRegression/PLR-SVM/PLR-Letter/PLR_{number}.csv"
    )
