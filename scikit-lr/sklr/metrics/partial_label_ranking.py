...
# Local application
from ._partial_label_ranking_fast import tau_x_score_fast, penalized_kendall_distance_fast  # noqa
...
def penalized_kendall_distance(Y_true, Y_pred, normalize=True,
    ...
    return dists if return_dists else np.average(dists, weights=sample_weight)
