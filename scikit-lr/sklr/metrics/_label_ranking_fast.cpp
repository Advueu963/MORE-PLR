 ...
 */
  ...
  /* "sklr/metrics/_label_ranking_fast.pyx":34
 ...
 */
    __pyx_t_4 = (__pyx_v_n_classes - 1);
    __pyx_t_5 = __pyx_t_4;
    for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_5; __pyx_t_6+=1) {
      __pyx_v_f_class = __pyx_t_6;

      /* "sklr/metrics/_label_ranking_fast.pyx":38
 *         for f_class in range(n_classes - 1):
 *             # Skip non-ranked classes
 *             if (Y_true[sample, f_class] == RANK_TYPE.RANDOM or             # <<<<<<<<<<<<<<
 ...
 */
      ...
      /* "sklr/metrics/_label_ranking_fast.pyx":42
 *                 continue
 *             else:
 *                 n_ranked_classes += 1             # <<<<<<<<<<<<<<
 ...
 */
        ...
        /* "sklr/metrics/_label_ranking_fast.pyx":48
 *                 if (Y_true[sample, f_class] < Y_true[sample, s_class] and
 *                         Y_pred[sample, f_class] > Y_pred[sample, s_class] or
 *                         Y_true[sample, f_class] > Y_true[sample, s_class] and             # <<<<<<<<<<<<<<
 *                         Y_pred[sample, f_class] < Y_pred[sample, s_class]):
 ...
 */
    ...
    /* "sklr/metrics/_label_ranking_fast.pyx":52
 *                     dists[sample] += 1
 * 
 *         if normalize:             # <<<<<<<<<<<<<<
...
/* "sklr/metrics/_label_ranking_fast.pyx":56
 * 
 * 
...
static void __pyx_f_4sklr_7metrics_19_label_ranking_fast_tau_score_fast(__pyx_t_4sklr_6_types_INT64_t_2D __pyx_v_Y_true, __pyx_t_4sklr_6_types_INT64_t_2D __pyx_v_Y_pred, __pyx_t_4sklr_6_types_DTYPE_t_1D __pyx_v_scores, CYTHON_UNUSED int __pyx_skip_dispatch) {
  ...
  /* "sklr/metrics/_label_ranking_fast.pyx":60
 *                           DTYPE_t_1D scores) nogil:
 ...
 */
  ...
  /* "sklr/metrics/_label_ranking_fast.pyx":61
 *     """Compute the Kendall tau."""
 *     cdef INT64_t n_samples = Y_true.shape[0]
 *     cdef INT64_t n_classes = Y_true.shape[1]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "sklr/metrics/_label_ranking_fast.pyx":70
 * 
 *     for sample in range(n_samples):
 *         n_ranked_classes = 0             # <<<<<<<<<<<<<<
 *         for f_class in range(n_classes - 1):
 ...
 */
    ...
    for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_5; __pyx_t_6+=1) {
      ...
      /* "sklr/metrics/_label_ranking_fast.pyx":73
 *         for f_class in range(n_classes - 1):
 *             # Skip non-ranked classes
 *             if (Y_true[sample, f_class] == RANK_TYPE.RANDOM or             # <<<<<<<<<<<<<<
 *                     Y_pred[sample, f_class] == RANK_TYPE.RANDOM):
 ...
 */
      ...
      /* "sklr/metrics/_label_ranking_fast.pyx":74
 *             # Skip non-ranked classes
 *             if (Y_true[sample, f_class] == RANK_TYPE.RANDOM or
 *                     Y_pred[sample, f_class] == RANK_TYPE.RANDOM):             # <<<<<<<<<<<<<<
 *                 continue
 ...
 */
        ...
        /* "sklr/metrics/_label_ranking_fast.pyx":82
 *                 # if the compared classes are in the same order
 *                 if (Y_true[sample, f_class] < Y_true[sample, s_class] and
 *                         Y_pred[sample, f_class] < Y_pred[sample, s_class] or             # <<<<<<<<<<<<<<
 *                         Y_true[sample, f_class] > Y_true[sample, s_class] and
 ...
 */
        ...
        /* "sklr/metrics/_label_ranking_fast.pyx":84
 *                         Y_pred[sample, f_class] < Y_pred[sample, s_class] or
 *                         Y_true[sample, f_class] > Y_true[sample, s_class] and
 *                         Y_pred[sample, f_class] > Y_pred[sample, s_class]):             # <<<<<<<<<<<<<<
 *                     scores[sample] += 1.0
 ...
 */
        if (__pyx_t_7) {
          ...
          /* "sklr/metrics/_label_ranking_fast.pyx":85
 *                         Y_true[sample, f_class] > Y_true[sample, s_class] and
 *                         Y_pred[sample, f_class] > Y_pred[sample, s_class]):
 *                     scores[sample] += 1.0             # <<<<<<<<<<<<<<
 *                 else:
 ...
 */
        ...
        /* "sklr/metrics/_label_ranking_fast.pyx":87
 *                     scores[sample] += 1.0
 *                 else:
 *                     scores[sample] -= 1.0             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "sklr/metrics/_label_ranking_fast.pyx":89
 *                     scores[sample] -= 1.0
 * 
 *         scores[sample] /= n_ranked_classes * (n_classes-1) / 2             # <<<<<<<<<<<<<<
 */
    __pyx_t_8 = __pyx_v_sample;
    *((__pyx_t_4sklr_6_types_DTYPE_t *) ( /* dim=0 */ (__pyx_v_scores.data + __pyx_t_8 * __pyx_v_scores.strides[0]) )) /= ((__pyx_v_n_ranked_classes * (__pyx_v_n_classes - 1)) / 2);
  }
...
static PyObject *__pyx_pw_4sklr_7metrics_19_label_ranking_fast_3tau_score_fast(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("tau_score_fast (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_Y_pred)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("tau_score_fast", 1, 3, 3, 1); __PYX_ERR(0, 56, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_scores)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("tau_score_fast", 1, 3, 3, 2); __PYX_ERR(0, 56, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "tau_score_fast") < 0)) __PYX_ERR(0, 56, __pyx_L3_error)
      }
    ...
    __pyx_v_Y_true = __Pyx_PyObject_to_MemoryviewSlice_dsds_nn___pyx_t_4sklr_6_types_INT64_t(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_Y_true.memview)) __PYX_ERR(0, 56, __pyx_L3_error)
    __pyx_v_Y_pred = __Pyx_PyObject_to_MemoryviewSlice_dsds_nn___pyx_t_4sklr_6_types_INT64_t(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_Y_pred.memview)) __PYX_ERR(0, 57, __pyx_L3_error)
    __pyx_v_scores = __Pyx_PyObject_to_MemoryviewSlice_ds_nn___pyx_t_4sklr_6_types_DTYPE_t(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_scores.memview)) __PYX_ERR(0, 58, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("tau_score_fast", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 56, __pyx_L3_error)
  __pyx_L3_error:;
...
static PyObject *__pyx_pf_4sklr_7metrics_19_label_ranking_fast_2tau_score_fast(CYTHON_UNUSED PyObject *__pyx_self, __pyx_t_4sklr_6_types_INT64_t_2D __pyx_v_Y_true, __pyx_t_4sklr_6_types_INT64_t_2D __pyx_v_Y_pred, __pyx_t_4sklr_6_types_DTYPE_t_1D __pyx_v_scores) {
  ...
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __Pyx_void_to_None(__pyx_f_4sklr_7metrics_19_label_ranking_fast_tau_score_fast(__pyx_v_Y_true, __pyx_v_Y_pred, __pyx_v_scores, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 56, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
