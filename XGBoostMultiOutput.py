...
from mutlOutRegr.utils_chain import model_evaluation, model_scores
from MORE_models import PLR_XGBoost_Regression
random_state = 0
data_id = 42855
# Authorship: 42834
# IRIS: 42851
...
if __name__ == '__main__':
    ...
    regr_model = PLR_XGBoost_Regression(n_estimators=100,
                                        random_state=random_state) # not really necessary but double is better

    regr_name = "MORT_XGBoost"
    clas_name = "JC_RF"
    ...
    df.to_csv("../data/MultiRegression/xgboost.csv")
